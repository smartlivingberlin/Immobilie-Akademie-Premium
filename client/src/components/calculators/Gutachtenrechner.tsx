      ...
      <CardContent>
        <Tabs defaultValue="vergleichswert">
          ...
          <TabsContent value="vergleichswert" className="space-y-6 mt-6">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="space-y-4">
                <div className="space-y-2"><Label>Vergleichspreis (€/m²)</Label><Input aria-label="Vergleichspreis (€/m²)" type="number" value={vergleichspreis} onChange={(e) => setVergleichspreis(e.target.value)} /></div>
          ...
          <TabsContent value="ertragswert" className="space-y-6 mt-6">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="space-y-4">
                <div className="space-y-2"><Label>Jahresrohertrag (€)</Label><Input aria-label="Jahresrohertrag (€)" type="number" value={jahresrohertrag} onChange={(e) => setJahresrohertrag(e.target.value)} /></div>
                <div className="space-y-2"><Label>Bewirtschaftungskosten (€)</Label><Input aria-label="Bewirtschaftungskosten (€)" type="number" value={bewirtschaftungskosten} onChange={(e) => setBewirtschaftungskosten(e.target.value)} /></div>
                <div className="space-y-2"><Label>Liegenschaftszinssatz (%)</Label><Input aria-label="Liegenschaftszinssatz (%)" type="number" step="0.1" value={liegenschaftszins} onChange={(e) => setLiegenschaftszins(e.target.value)} /></div>
                <div className="space-y-2"><Label>Bodenwert (€)</Label><Input aria-label="Bodenwert (€)" type="number" value={bodenwert} onChange={(e) => setBodenwert(e.target.value)} /></div>
              </div>

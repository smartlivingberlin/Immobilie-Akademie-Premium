          ...
          <TabsContent value="vergleichswert" className="space-y-6 mt-6">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="space-y-4">
                ...
                <div className="space<Input aria-label="Eingabefeld" type="number" value={wohnflaeche} onChange={(e) => setWohnflaeche(e.target.value)} />> setWohnflaeche(e.target.value)} /></div>
         <Input aria-label="Eingabefeld" type="number" step="0.1" value={zuschlag} onChange={(e) => setZuschlag(e.target.value)} />e={zuschlag} onChange={(e) => setZuschlag(e.target.v<Input aria-label="Eingabefeld" type="number" step="0.1" value={abschlag} onChange={(e) => setAbschlag(e.target.value)} />="number" step="0.1" value={abschlag} onChange={(e) => setAbschlag(e.target.value)} /></div>
              </div>
          ...
          <TabsContent value="ertragswert" className="space-y-6 mt-6">
            ...
            <div className="grid gap-6 md:grid-cols-2">
        <Input aria-label="Eingabefeld" type="number" value={jahresrohertrag} onChange={(e) => setJahresrohertrag(e.target.value)} />(€)</Label><Input type="number" value={jahresrohertrag} onChange={<Input aria-label="Eingabefeld" type="number" value={bewirtschaftungskosten} onChange={(e) => setBewirtschaftungskosten(e.target.value)} />ungskosten (€)</Label><Input type="number" value={bewirtschaftung<Input aria-label="Eingabefeld" type="number" step="0.1" value={liegenschaftszins} onChange={(e) => setLiegenschaftszins(e.target.value)} />-y-2"><Label>Liegenschaftszinssatz (%)</Label><Input <Input aria-label="Eingabefeld" type="number" value={bodenwert} onChange={(e) => setBodenwert(e.target.value)} />(e.target.value)} /></div>
          ...
          <TabsContent value="sachwert" className="space-y-6 mt-6">
            <Alert><Info className="h-4 w-4" /><AlertDescription>Sachwertverfahren gemäß §§ 21-23 ImmoWertV: Bewertung nach Herstellungskosten abzüglich Alters<Input aria-label="Eingabefeld" type="number" value={bodenwert} onChange={(e) => setBodenwert(e.target.value)} />-cols-2">
              <div className="space-y-4">
          <Input aria-label="Eingabefeld" type="number" value={herstellungskosten} onChange={(e) => setHerstellungskosten(e.target.value)} />ge={(e) => setBodenwert(e.target.value)} /></div>
   <Input aria-label="Eingabefeld" type="number" value={alter} onChange={(e) => setAlter(e.target.value)} />put type="number" value={herstellungskosten} onChange={(e) => setHe<Input aria-label="Eingabefeld" type="number" value={gesamtnutzungsdauer} onChange={(e) => setGesamtnutzungsdauer(e.target.value)} />Label><Input type="number" value={alter} onChange={(e) => setAlter(e.target.value)} /></div>

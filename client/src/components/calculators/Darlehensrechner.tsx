      ...
      <CardContent>
        <Tabs defaultValue="annuitaet">
          ...
          <TabsContent value="annuitaet" className="space-y-6 mt-6">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="space-y-4">
                ...
                <div className="space-y-2"><La<Input aria-label="Eingabefeld" type="number" step="0.01" value={zinssatz} onChange={(e) => setZinssatz(e.target.value)} />> setZinssatz(e.target.value)} /></div>
                <div classNa<Input aria-label="Eingabefeld" type="number" step="0.1" value={tilgungssatz} onChange={(e) => setTilgungssatz(e.target.value)} />satz} onChange={(e) => setTilgungssatz(e.target.value)} /></div>
              </div>
          ...
          <TabsContent value="sondertilgung" className="space-y-6 mt-6">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="spac<Input aria-label="Eingabefeld" type="number" value={sondertilgung} onChange={(e) => setSondertilgung(e.target.value)} />number" value={sondertilgung} onChange={(e) => setSonder<Input aria-label="Eingabefeld" type="number" value={sondertilgungJahr} onChange={(e) => setSondertilgungJahr(e.target.value)} />bel><Input type="number" value={sondertilgungJahr} onChange={(e) => setSondertilgungJahr(e.target.value)} /></div>
              </div>

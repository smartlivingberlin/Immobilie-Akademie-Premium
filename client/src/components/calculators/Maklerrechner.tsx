      ...
      <CardContent>
        <Tabs defaultValue="kauf">
          ...
          <TabsContent value="kauf" className="space-y-6 mt-6">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="space-y-4">
                ...
                <div className="space-y-2"><Label>Provisionss<Input aria-label="Eingabefeld" type="number" step="0.01" value={provisionssatz} onChange={(e) => setProvisionssatz(e.target.value)} />onssatz(e.target.value)} /></div>
                <div classN<Input aria-label="Eingabefeld" type="number" value={aufteilung} onChange={(e) => setAufteilung(e.target.value)} />} onChange={(e) => setAufteilung(e.target.value)} /></div>
              </div>
          ...
          <TabsContent value="vermietung" className="space-y-6 mt-6">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="space-y-4">
<Input aria-label="Eingabefeld" type="number" value={kaltmiete} onChange={(e) => setKaltmiete(e.target.value)} />="number" value={kaltmiete} onChange={(e) => setKaltmiete(e.targ<Input aria-label="Eingabefeld" type="number" step="0.1" value={provisionMonate} onChange={(e) => setProvisionMonate(e.target.value)} />pe="number" step="0.1" value={provisionMonate} onChange={(e) => setProvisionMonate(e.target.value)} /></div>
              </div>
          ...
          <TabsContent value="netto" className="space-y-6 mt-6">
            ...
            <div className="grid gap-6 md:grid-<Input aria-label="Eingabefeld" type="number" value={nettoProvision} onChange={(e) => setNettoProvision(e.target.value)} />el>Nettoprovision (€)</Label><Input type="number" value={nettoProvision} onChange={(e) => setNettoProvision(e.target.value)} /></div>
              </div>

      ...
      <CardContent>
        <Tabs defaultValue="warmmiete">
          ...
          <TabsContent value="warmmiete" className="space-y-6 mt-6">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="space-y-4">
                ...
                <div className="space-y-2<Input aria-label="Eingabefeld" type="number" value={nebenkosten} onChange={(e) => setNebenkosten(e.target.value)} /> => setNebenkosten(e.target.value)} /></div>
              </div>
          ...
          <TabsContent value="erhoehung" className="space-y-6 mt-6">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="space-y-4">
                <div cl<Input aria-label="Eingabefeld" type="number" value={aktuelleKaltmiete} onChange={(e) => setAktuelleKaltmiete(e.target.value)} />iete} onChange={(e) => setAktuelleKaltmiete(e.target.value)} /></div><Input aria-label="Eingabefeld" type="number" value={neueMiete} onChange={(e) => setNeueMiete(e.target.value)} /><Input type="number" value={neueMiete} onChange={(e) => setNeueMiete(e.target.value)} /></div>
          ...
          <TabsContent value="betriebskosten" className="space-y-6 mt-6">
            ...
            <div className="grid gap-6 md:grid-cols-2">
  <Input aria-label="Eingabefeld" type="number" value={wohnflaeche} onChange={(e) => setWohnflaeche(e.target.value)} />hnfläche (m²)</Label><Input type="number" value={wohnflaeche} onChange=<Input aria-label="Eingabefeld" type="number" value={gesamtkosten} onChange={(e) => setGesamtkosten(e.target.value)} />abel>Gesamte Betriebskosten (€/Jahr)</Label><Input type="numb<Input aria-label="Eingabefeld" type="number" value={gesamtflaeche} onChange={(e) => setGesamtflaeche(e.target.value)} />    <div className="space-y-2"><Label>Gesamtwohnfläche (m²)</Label><Input type="number" value={gesamtflaeche} onChange={(e) => setGesamtflaeche(e.target.value)} /></div>
              </div>

    ...
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-8 flex gap-3">
          ...
          <p className="text-sm text-amber-700"><strong className="text-amber-800">Wichtiger Hinweis:</strong> Eine AZAV-Zertifizierung wird angestrebt. Förderfähigkeit, Bewilligung und steuerliche Anerkennung hängen vom Einzelfall ab.</p>
        </div>

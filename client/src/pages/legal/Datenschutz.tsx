      ...
      <Card>
        ...
        <CardContent className="prose prose-slate max-w-none">
          ...
          <p>
            ...
            Andere Daten können zur Analyse Ihres Nutzerverhaltens verwendet werden, sofern Sie hierzu Ihre 
          ...
          <p>
            ...
            10715 Berlin<br />
            <br />
            Telefon: +49 171 1526327<br />
            E-Mail: <a href="mailto:gadyri@icloud.com" className="text-blue-600 hover:underline">gadyri@icloud.com</a>
          </p>
          <p>
          ...
          <p>
            ...
            Webseiten funktionen ohne diese nicht funktionieren würden (z.B. die Speicherung Ihres Lernfortschritts). 
          ...
          <p>
            ...
            von Ihnen erwünschter Funktionen (z.B. für die Lernfortschritts-Funktion) oder zur Optimierung der 
            Website (z.B. Cookies zur Messung des Webpublikums) erforderlich sind (notwendige Cookies), werden auf 
            Grundlage von Art. 6 Abs. 1 lit. f DSGVO gespeichert, sofern keine andere Rechtsgrundlage angegeben wird. 
            Der Websitebetreiber hat ein berechtigtes Interesse an der Speicherung von notwendigen Cookies zur 
            technisch fehlerfreien und optimierten Bereitstellung seiner Dienste. Sofern eine Einwilligung zur 
            Speicherung von Cookies und vergleichbaren Wiedererkennungstechnologien abgefragt wurde, erfolgt die 
            Verarbeitung ausschließlich auf Grundlage dieser Einwilligung (Art. 6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 TDDDG); 
          ...
          <h3>Umami Analytics (Optional mit Einwilligung)</h3>
          <p>
            Diese Website nutzt optional den Webanalysedienst Umami. Umami ist eine datenschutzfreundliche 
            Open-Source-Analyseplattform, die keine personenbezogenen Daten erfasst und keine Cookies verwendet.
          </p>
          <p>
            Umami erfasst nur anonymisierte Daten wie:
          </p>
          <ul>
            <li>Besuchte Seiten</li>
            <li>Verweildauer</li>
            <li>Browsertyp und Betriebssystem (ohne Versionsnummer)</li>
            <li>Herkunftsland (basierend auf anonymisierter IP)</li>
          </ul>
          <p>
            Die Nutzung von Umami erfolgt nur nach Ihrer ausdrücklichen Einwilligung (Art. 6 Abs. 1 lit. a DSGVO 
            und § 25 Abs. 1 TDDDG). Sie können Ihre Einwilligung jederzeit über die Cookie-Einstellungen widerrufen.
          </p>
          <p>
            IP-Adressen werden nicht gespeichert. Eine Identifizierung einzelner Nutzer ist nicht möglich.
          </p>
          ...
          <p>
            Diese Seite nutzt zur einheitlichen Darstellung von Schriftarten so genannte Google Fonts. Die Google 
            Fonts sind lokal installiert. Eine Verbindung zu Servern von Google findet dabei nicht statt.
          </p>

          <h2>7. Eigene Dienste</h2>

          <h3>Lernfortschritts-Tracking</h3>
          <p>
            Diese Website bietet die Möglichkeit, Ihren Lernfortschritt zu speichern. Die Speicherung erfolgt 
            ausschließlich lokal in Ihrem Browser (localStorage) und wird nicht an unsere Server übertragen. 
            Sie haben jederzeit die Möglichkeit, diese Daten über die Einstellungen Ihres Browsers zu löschen.
          </p>

          <h3>Lernkarten-System (Spaced Repetition)</h3>
          <p>
            Das Lernkarten-System speichert Ihren Lernfortschritt und Wiederholungsintervalle lokal in Ihrem 
            Browser (localStorage). Diese Daten werden nicht an unsere Server übertragen und verbleiben ausschließlich 
            auf Ihrem Endgerät.
          </p>

          <h3>Quiz-Ergebnisse</h3>
          <p>
            Die Ergebnisse der interaktiven Quiz werden lokal in Ihrem Browser gespeichert (localStorage) und 
            dienen ausschließlich Ihrer persönlichen Lernfortschrittskontrolle. Eine Übertragung an unsere Server 
            erfolgt nicht.
          </p>

          <h2>8. Zertifikate</h2>
          <p>
            Nach erfolgreichem Abschluss eines Moduls haben Sie die Möglichkeit, ein Teilnahmezertifikat zu 
            generieren. Die Zertifikatsgenerierung erfolgt lokal in Ihrem Browser. Dabei werden folgende Daten verwendet:
          </p>
          <ul>
            <li>Ihr Name (von Ihnen eingegeben)</li>
            <li>Modulbezeichnung</li>
            <li>Abschlussdatum</li>
            <li>Lernfortschritt (aus localStorage)</li>
          </ul>
          <p>
            Diese Daten werden nicht an unsere Server übertragen. Das Zertifikat wird als PDF-Datei auf Ihrem 

...
5.  Bestellerprinzip (Wohnraummiete).
  ...
  day_56: {
    ...
    theory: "Wiederholung Bewertung und Technik als Praxisvorbereitung Para 34c GewO (Erlaubnis verlangt keinen IHK-Sachkundenachweis). Kernthemen Wertermittlung: Vergleichswert-, Sachwert- und Ertragswertverfahren nach ImmoWertV 2021. Bodenwertermittlung: Bodenrichtwerte, Gutachterausschuss, Para 196 BauGB. Technische Grundlagen: Energieausweis GEG 2023, Wohnflaechenberechnung WoFlV vs DIN 277, Grundbuch lesen (Abt I-III), Baurecht Bebauungsplan vs Para 34 BauGB. Lernzielkontrolle: Multiple-Choice-Fragen und Rechenaufgaben. Letzte Vorbereitung: Formeln wiederholen, Beispielberechnungen durchfuehren.",
    extendedTheory: `Wiederholung Wertermittlung: Vergleichswertverfahren (Para 15 ImmoWertV), Sachwertverfahren (Para 21 ImmoWertV), Ertragswertverfahren (Para 27 ImmoWertV). Bodenwertermittlung: Bodenrichtwerte nach Para 196 BauGB, Gutachterausschuss Para 193 BauGB. Technische Grundlagen: Energieausweis GEG 2023 (Verbrauchs- vs Bedarfsausweis), Wohnflaechenberechnung WoFlV vs DIN 277, Grundbuch Abt I-III lesen und verstehen. Lernzielkontrolle: Multiple-Choice und Rechenaufgaben. Formeln wiederholen, Beispielberechnungen durchfuehren, Zeitmanagement bei Pruefung beachten.`,
    law: [
  ...
  day_57: {
    ...
    theory: "Wiederholung Marketing und Vertrieb als Praxisvorbereitung Para 34c GewO. Kernthemen: Vermarktungsstrategien (Farming, Social Media, Portale), Exposeverstellung, Besichtigungsdramaturgie, Verkaufspsychologie, Preisverhandlung. Rechtliche Aspekte: Fernabsatzrecht (Para 312 BGB), Widerrufsrecht, UWG-Werberecht, DSGVO-konformes Marketing. Digitales Marketing: ImmoScout24, Immowelt, Social-Media-Strategie, SEO fuer Makler. Lernschwerpunkte: Provision (Para 656c BGB Halbierungsprinzip), Wettbewerbsrecht, Datenschutz im Marketing.",
    extendedTheory: `Wiederholung Marketing und Vertrieb Para 34c GewO. Vermarktungsstrategien: Farming-Ansatz, Social-Media-Marketing, Immobilienportale (ImmoScout24, Immowelt). Exposeerstellung: Pflichtangaben, professionelle Fotos, Grundrissdarstellung. Besichtigungsdramaturgie und Verkaufspsychologie. Rechtliche Aspekte: UWG-Werberecht Para 7, DSGVO-konformes Marketing Art. 6 DSGVO, Fernabsatzrecht Para 312 BGB. Provisionrecht: Para 656c BGB Halbteilungsprinzip. Lernschwerpunkte: Rechtliche Grenzen der Werbung, Datenschutz bei Kundendaten, Maklervertrag und Provision.`,
    law: [
  ...
  day_58: {
    ...
    theory: "Abschluss-Lernkontrolle Teil 1 - Recht und Vertraege. 30 praxisorientierte Wiederholungsfragen zu: Para 34c GewO (Voraussetzungen, Pflichten, Erlaubnisversagungsgruende), BGB-Maklerrecht Para 652-656d BGB (Provision, Widerrufsrecht, Halbierungsprinzip), GwG Geldwaeschegesetz (Sorgfaltspflichten, Meldepflicht), DSGVO (Rechtsgrundlagen, Betroffenenrechte), Verbraucherschutz (Fernabsatz, Widerruf). Zeitlimit: 60 Minuten fuer 30 Fragen. Zielwert fuer die Lernkontrolle: 70 Prozent korrekte Antworten. Tipp: Gesetzestexte nochmals lesen.",
    extendedTheory: `Abschlussvorbereitung Teil 1 - Recht und Vertraege Para 34c GewO. Lernthemen: Erlaubnisvoraussetzungen Para 34c GewO, Maklervertrag Para 652-656d BGB, Provision und Halbteilungsprinzip Para 656c BGB, Widerrufsrecht Para 312 BGB, Geldwaeschegesetz GwG Sorgfaltspflichten, DSGVO Rechtsgrundlagen Art. 6, Verbraucherschutz. Lernzielkontrolle: Wiederholungsfragen, Fallbeispiele und Zeitmanagement. Tipp: Gesetzestexte nochmals lesen, Fallbeispiele loesen, Zeitlimit einhalten.`,
    law: [
  ...
  day_59: {
    ...
    theory: "Abschluss-Lernkontrolle Teil 2 - Bewertung und Praxis. 30 praxisorientierte Aufgaben zu: Wertermittlungsverfahren (Vergleichswert, Sachwert, Ertragswert berechnen), Grundbuchrecht (Abteilungen I-III interpretieren), Baurecht (B-Plan vs Para 34 BauGB), Finanzierung (Annuitaetendarlehen, Beleihungsauslauf), Praxissituationen (Kundengespräch, Exposepruefung). Zeitlimit: 60 Minuten. Rechenaufgaben: Taschenrechner erlaubt. Vorbereitung: Wiederholungsaufgaben und Praxisfaelle loesen.",
    extendedTheory: `Abschlussvorbereitung Teil 2 - Bewertung und Praxis Para 34c GewO. Lernthemen: Wertermittlungsverfahren (Vergleich, Sachwert, Ertragswert berechnen), Grundbuchrecht Abt I-III, Baurecht Bebauungsplan vs Para 34 BauGB, Finanzierungsgrundlagen (Annuitaetendarlehen, Beleihungsauslauf), Praxissituationen (Kundengespräch, Objektaufnahme). Rechenaufgaben: Taschenrechner erlaubt. Zeitmanagement: 60 Minuten fuer 30 Aufgaben. Letzte Vorbereitung: Wiederholungsaufgaben und Praxisfaelle loesen.`,
    law: [
  ...
  day_60: {
    ...
    theory: "Abschluss und Ausblick: Sie haben das komplette Handwerkszeug für die Maklertätigkeit erworben. §34c-Erlaubnis (Zuverlässigkeit + geordnete Vermögensverhältnisse, kein Sachkundenachweis erforderlich), Weiterbildungspflicht nach §15b MaBV (Abschaffung geplant) und nächste Karriereschritte.",
    extendedTheory: `
### Die ersten 100 Tage

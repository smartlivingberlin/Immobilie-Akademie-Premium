...
5.  Bestellerprinzip (Wohnraummiete).
  ...
  day_58: {
    ...
    extendedTheory: `Abschlusspruefungsvorbereitung Teil 1 - Recht und Vertraege Para 34c GewO. Pruefungsthemen: Erlaubnisvoraussetzungen Para 34c GewO, Maklervertrag Para 652-656d BGB, Provision und Halbteilungsprinzip Para 656c BGB, Widerrufsrecht Para 312 BGB, Geldwaeschegesetz GwG Sorgfaltspflichten, DSGVO Rechtsgrundlagen Art. 6, Verbraucherschutz. Pruefungsformat: 60 Fragen in 90 Minuten, 70 Prozent Bestehensgrenze. Tipp: Gesetzestexte nochmals lesen, Fallbeispiele loesen, Zeitlimit einhalten.`,
    law: [
  ...
  day_59: {
    ...
    extendedTheory: `Abschlusspruefungsvorbereitung Teil 2 - Bewertung und Praxis Para 34c GewO. Pruefungsthemen: Wertermittlungsverfahren (Vergleich, Sachwert, Ertragswert berechnen), Grundbuchrecht Abt I-III, Baurecht Bebauungsplan vs Para 34 BauGB, Finanzierungsgrundlagen (Annuitaetendarlehen, Beleihungsauslauf), Praxissituationen (Kundengespräch, Objektaufnahme). Rechenaufgaben: Taschenrechner erlaubt. Zeitmanagement: 60 Minuten fuer 30 Aufgaben. Letzte Vorbereitung: IHK-Musterpruefungen aus letzten 3 Jahren loesen.`,
    law: [

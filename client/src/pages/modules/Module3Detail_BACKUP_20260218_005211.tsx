...
export default function Module3Detail() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      {/* Header - Matching Module 2 Design */}
            ...
            <div className="flex justify-between items-start">
              <div>
                ...
                <CardTitle className="text-3xl font-bold text-slate-900">
                  Modul 3: Immobilienverwaltung
                </CardTitle>
                <CardDescription className="text-slate-600">
                  640 Unterrichtseinheiten • 80 Tage
                </CardDescription>
              </div>
              <div className="text-right">
                <div className="text-sm text-slate-600 mb-2">Fortschritt</div>
                <div className="text-sm font-medium">Tag {currentDayNum} von 80</div>
                <Progress value={progress} className="w-32 mt-2 h-2" />
              </div>
            </div>
          </CardHeader>
        </Card>
                ...
                <CardContent className="p-6 flex-1">
                  <Tabs defaultValue="theory" className="w-full">
                    <TabsList className="grid w-full grid-cols-4 mb-8 bg-slate-100 p-1 rounded-xl">
                      <TabsTrigger 
                        value="theory" 
                        className="data-[state=active]:bg-white data-[state=active]:text-purple-700 data-[state=active]:shadow-sm rounded-lg"
                      >
                    ...
                    <TabsContent value="theory" className="mt-0 space-y-6 animate-in fade-in-50 focus-visible:outline-none">
                        ...
                        content={
                          <div className="prose prose-slate max-w-none break-words">
                            ...
                            {currentContent.law.map((law, idx) => (
                              <div key={idx} className="flex items-center gap-3 bg-white p-3 rounded-lg border border-slate-200 text-sm font-medium hover:border-purple-300 hover:shadow-sm transition-all">
                      ...
                      <div className="prose prose-slate max-w-none break-words prose-headings:text-slate-900 prose-a:text-purple-600 prose-strong:text-slate-900">
                        <ReactMarkdown>{currentContent.theory}</ReactMarkdown>
                      ...
                      <FullscreenContent 
                        content={
                          <div className="prose prose-slate max-w-none break-words">
                            {currentContent.law && currentContent.law.length > 0 ? (
                              <div>
                                <h2 className="text-2xl font-bold text-slate-900 mb-6">Gesetzliche Grundlagen</h2>
                                <div className="grid gap-4 sm:grid-cols-2">
                                  {currentContent.law.map((law, idx) => (
                                    <div key={idx} className="flex items-center gap-3 bg-white p-4 rounded-lg border border-slate-200 text-sm font-medium hover:border-purple-300 hover:shadow-sm transition-all">
                              ...
                              <p className="text-slate-600">Keine gesetzlichen Grundlagen für diesen Tag definiert.</p>
                            )}
                          </div>
                        } 
                        title={`Normen: ${currentContent.title}`} 
                      />

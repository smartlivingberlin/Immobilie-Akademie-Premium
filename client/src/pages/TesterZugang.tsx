    ...
    <div style={{ minHeight: "100vh", background: "#0f172a", display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }}>
      <div style={{ background: "#1e293b", borderRadius: 16, padding: "40px 36px", width: "100%", maxWidth: 420, border: "1px solid #334155" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          ...
          <h1 style={{ fontFamily: "Fraunces, Georgia, serif", fontSize: 24, fontWeight: 800, color: "#f1f5f9", margin: "0 0 8px" }}>
            Tester-Zugang
          </h1>
                ...
                {[48, 72, 168].map(h => (
                  <button key={h} onClick={() => setHours(h)}
                    style={{ flex: 1, padding: "10px", borderRadius: 8, fontSize: 13, fontWeight: 700, cursor: "pointer", border: "none",
                      background: hours === h ? "#1d4ed8" : "#0f172a",
        ...
        {step === "code" && (
          <div>
            <p style={{ color: "#94a3b8", fontSize: 13, marginBottom: 24, lineHeight: 1.6 }}>
              Wir haben einen 6-stelligen Code an <strong style={{ color: "#f1f5f9" }}>{email}</strong> gesendet. Bitte prüfe dein Postfach.
            </p>
        ...
        {step === "success" && (
          <div style={{ textAlign: "center" }}>
            ...
            <p style={{ color: "#94a3b8", fontSize: 13, lineHeight: 1.6 }}>
              ...
              <br />Zugang gültig bis: <strong style={{ color: "#f1f5f9" }}>{expiresAt}</strong>
            </p>
          </div>
        )}

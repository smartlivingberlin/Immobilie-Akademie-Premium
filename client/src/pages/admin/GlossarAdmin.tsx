  ...
  return (
    <div style={{ maxWidth: 900, margin: "0 auto", padding: "24px 20px" }}>
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 24 }}>
        ...
        <h1 style={{ fontSize: fz(22), fontWeight: 700, margin: 0 }}>Glossar-Manager</h1>
        <span style={{ background: "#f1f5f9", padding: "2px 10px", borderRadius: 20, fontSize: fz(13), color: "#64748b" }}>{terms.length} Begriffe</span>
      ...
      {(showNew || editId !== null) && (
        <div style={{ background: "#f8fafc", border: "1px solid #e2e8f0", borderRadius: 12, padding: 20, marginBottom: 20 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 12 }}>
            <div>
              <label style={{ fontSize: fz(12), fontWeight: 600, color: "#64748b" }}>Begriff *</label>
            ...
            <div>
              <label style={{ fontSize: fz(12), fontWeight: 600, color: "#64748b" }}>Kategorie *</label>
          ...
          <div style={{ marginBottom: 12 }}>
            <label style={{ fontSize: fz(12), fontWeight: 600, color: "#64748b" }}>Definition *</label>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 16 }}>
            <div>
              <label style={{ fontSize: fz(12), fontWeight: 600, color: "#64748b" }}>Gesetzesreferenz</label>
              <input value={form.lawReference} onChange={e => setForm(p => ({...p, lawReference: e.target.value}))}
                placeholder="z.B. § 34c GewO"
                style={{ width: "100%", padding: "8px 12px", border: "1px solid #e2e8f0", borderRadius: 8, marginTop: 4, boxSizing: "border-box" as any }} />
            </div>
            <div>
              <label style={{ fontSize: fz(12), fontWeight: 600, color: "#64748b" }}>Gesetz-Link</label>
      ...
      <input value={filter} onChange={e => setFilter(e.target.value)} placeholder="Begriff oder Kategorie suchen..."
        style={{ width: "100%", padding: "10px 14px", border: "1px solid #e2e8f0", borderRadius: 10, marginBottom: 16, boxSizing: "border-box" as any, fontSize: fz(14) }} />
            ...
            <div key={t.id} style={{ background: editId === t.id ? "#f0fdf4" : "white", border: "1px solid #e2e8f0", borderRadius: 10, padding: "14px 16px", display: "flex", alignItems: "flex-start", gap: 12 }}>
              <div style={{ flex: 1 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 4 }}>
                  <span style={{ fontWeight: 700, fontSize: fz(15) }}>{t.term}</span>
                  <span style={{ background: "#f1f5f9", color: "#64748b", fontSize: fz(11), padding: "2px 8px", borderRadius: 20 }}>{t.category}</span>
                  {t.lawReference && <span style={{ color: "#0f766e", fontSize: fz(11), fontWeight: 600 }}>{t.lawReference}</span>}
                </div>
                <p style={{ margin: 0, fontSize: fz(13), color: "#64748b", lineHeight: 1.5 }}>{t.definition.slice(0, 120)}{t.definition.length > 120 ? "..." : ""}</p>
              </div>

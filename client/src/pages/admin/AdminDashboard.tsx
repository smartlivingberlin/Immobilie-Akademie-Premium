...
export default function AdminDashboard() {
  ...
  const CHECKLIST = [
    ...
    { label: `${PUBLIC_QUIZ_QUESTION_COUNT} Lernfragen + 45+ Praxisaufgaben verifiziert`, ok: true },
  ...
  const TOOLS = [
    ...
    { group: "📚 Inhalte & Lernmaterial", items: [
      ...
      { name: "Fragen-Manager", desc: `${(questions?.total && questions.total > 100) ? questions.total : PUBLIC_QUIZ_QUESTION_COUNT} Lernfragen`, href: "/admin/fragen", icon: FileQuestion, color: "#0891b2" },
    ...
    <div style={{ maxWidth: 1200, margin: "0 auto", padding: "24px 20px" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(6, 1fr)", gap: 10, marginBottom: 24 }}>
        {[
          ...
          { label: "Lernfragen", value: (questions?.total && questions.total > 100) ? questions.total : PUBLIC_QUIZ_QUESTION_COUNT, sub: "5 Module", icon: FileQuestion, color: "#059669" },
      ...
      {activeTab === "content" && (
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12 }}>
          {[
            ...
            { name: "Fragen-Manager", desc: `${questions?.total ?? PUBLIC_QUIZ_QUESTION_COUNT} Lernfragen verwalten.`, href: "/admin/fragen", icon: FileQuestion, color: "#0891b2", stats: `${PUBLIC_QUIZ_QUESTION_COUNT} Lernfragen` },

  ...
  if (phase === "liste") return (
    <div style={{ maxWidth: 800, margin: "0 auto", padding: "24px 16px" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 24 }}>
        ...
        <div>
          <h1 style={{ fontSize: fz(22), fontWeight: 800, color: "#0f172a", margin: 0 }}>
            Offene Prüfungsfragen
          </h1>
          <p style={{ fontSize: fz(13), color: "#64748b", margin: 0 }}>
        ...
        <div style={{
          ...
          {[
            ...
            <div key={s.label} style={{ textAlign: "center" }}>
              <div style={{ fontSize: fz(24), fontWeight: 800, color: "#7c3aed" }}>{s.value}</div>
          ...
          {fragen.map((f, i) => {
            ...
            return (
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ fontSize: fz(14), fontWeight: 600, color: "#0f172a", marginBottom: 4, lineHeight: 1.4 }}>
                    {f.frage.length > 120 ? f.frage.slice(0, 120) + "…" : f.frage}
                  </div>
                  <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                    <span style={{
                      fontSize: fz(11), background: f.schwierigkeit === "leicht" ? "#dcfce7" : f.schwierigkeit === "schwer" ? "#fee2e2" : "#fef3c7",
                      color: f.schwierigkeit === "leicht" ? "#16a34a" : f.schwierigkeit === "schwer" ? "#dc2626" : "#d97706",
                      padding: "2px 8px", borderRadius: 6, fontWeight: 600,
                    }}>{f.schwierigkeit}</span>
                    <span style={{ fontSize: fz(11), color: "#64748b" }}>{f.maxPunkte} Punkte</span>
                    <span style={{ fontSize: fz(11), color: "#64748b" }}>⏱ {f.zeitlimitMin} Min</span>
                    {f.kategorie && <span style={{ fontSize: fz(11), color: "#94a3b8" }}>{f.kategorie}</span>}
                    {letztePunkte && (
                      <span style={{
                        fontSize: fz(11), color: "#7c3aed", fontWeight: 700,
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "24px 16px" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
          <button onClick={() => { setLaeuft(false); setPhase("liste"); }}
            style={{ background: "none", border: "none", color: "#64748b", cursor: "pointer", fontSize: fz(13) }}>
            ← Zurück zur Liste
          </button>
          <div style={{
            ...
            color: warnung ? "#dc2626" : "#374151", fontWeight: 700, fontSize: fz(14),
          }}>
            <Clock size={14} />
            {mm}:{ss}
          </div>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", gap: 8, marginBottom: 12, flexWrap: "wrap" }}>
            <span style={{
              fontSize: fz(11), background: "#ede9fe", color: "#7c3aed",
              padding: "3px 10px", borderRadius: 6, fontWeight: 700
            }}>
              {aktiveFrageObj.maxPunkte} Punkte
            </span>
            <span style={{ fontSize: fz(11), color: "#64748b", padding: "3px 6px" }}>
              {MODUL_NAMES[modulId]}
            </span>
          </div>
          <h2 style={{ fontSize: fz(17), fontWeight: 700, color: "#0f172a", lineHeight: 1.5, margin: "0 0 16px" }}>
          ...
          {aktiveFrageObj.kontext && (
            <div style={{
              ...
              fontSize: fz(13), color: "#0369a1", lineHeight: 1.5
            }}>
        ...
        <div style={{ background: "white", borderRadius: 16, padding: 20, border: "1px solid #e2e8f0", marginBottom: 16 }}>
          <label style={{ display: "block", fontSize: fz(13), fontWeight: 600, color: "#374151", marginBottom: 8 }}>
            Deine Antwort:
          </label>
          <textarea
            value={antwort}
            ...
            style={{
              ...
              borderRadius: 10, padding: "12px 14px", fontSize: fz(14),
        ...
        <button
          ...
          style={{
            ...
            border: "none", borderRadius: 12, fontSize: fz(15),
    ...
    return (
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "24px 16px" }}>
        ...
        <div style={{
          ...
          <div style={{ fontSize: fz(56), fontWeight: 900, color: farbe, lineHeight: 1 }}>
            {ergebnis.punkte}/{ergebnis.maxPunkte}
          </div>
          <div style={{ fontSize: fz(18), fontWeight: 700, color: farbe, marginTop: 4 }}>
            {note} · {pct}%
          </div>
          <div style={{ fontSize: fz(13), color: "#64748b", marginTop: 6 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14, marginBottom: 20 }}>
          {[
            ...
            <div key={item.titel} style={{
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8, fontWeight: 700, fontSize: fz(14), color: "#0f172a" }}>
                {item.icon} {item.titel}
              </div>
              <p style={{ margin: 0, fontSize: fz(14), color: "#374151", lineHeight: 1.6 }}>
                {item.text}
              </p>
            </div>
          ))}
        ...
        <details style={{ background: "white", border: "1px solid #e2e8f0", borderRadius: 12, marginBottom: 20 }}>
          <summary style={{ padding: "14px 18px", cursor: "pointer", fontWeight: 700, fontSize: fz(14), color: "#374151" }}>
            📋 Musterlösung anzeigen
          </summary>
          <div style={{ padding: "0 18px 14px", fontSize: fz(14), color: "#374151", lineHeight: 1.7, borderTop: "1px solid #f1f5f9" }}>
        ...
        <div style={{ display: "flex", gap: 12 }}>
          <button
            ...
            style={{
              ...
              fontSize: fz(14), fontWeight: 600, cursor: "pointer"
            }}
          >
            ← Zur Fragenliste
          </button>
          <button
            ...
            style={{
              ...
              fontSize: fz(14), fontWeight: 700, cursor: "pointer",

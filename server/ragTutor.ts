  ...
  app.post("/api/ai/generate-kursbuch-v2", requireAuth, async (req: Request, res: Response) => {
    try {
      ...
      const formatInstructions: Record<string, string> = {
        ...
        skript: "Erstelle ein vollständiges LERNKONTROLL-SKRIPT mit MINDESTENS 3000 Wörtern: 1) 30 praxisnahe Wiederholungsfragen im Frage-Antwort-Format mit ausführlichen Musterlösungen 2) Alle prüfungsrelevanten Paragraphen mit Erklärung 3) Rechenwege für Berechnungsaufgaben Schritt für Schritt 4) Tipps fuer Lernkontrolle und Praxissituation. Vollständig ausschreiben — nichts kürzen.",
      };
